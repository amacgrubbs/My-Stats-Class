...
``` {r,echo=FALSE}
plot(ballots-votes,main="Voting Discrepancies Among Counties",xlab="Counties",ylab="Number of Ballots Not Counted")
```
...
``` {r,echo=FALSE}
plot(equip,ballots-votes,main="Voting Discrepancies Versus Equipment Type",xlab="Voting Equipment Type",ylab="Number of Ballots Not Counted")
```
...
``` {r,echo=FALSE}
plot(poor,ballots-votes,main="Voting Discrepancies Versus County Poverty",xlab="County Poverty (0-1 (Poor))",ylab="Number of Ballots Not Counted")
```
...
``` {r,echo=FALSE}
plot(equip,poor,main="Equipment Types Versus County Poverty",xlab="Voting Equipment Type",ylab="County Poverty (0-1 (Poor))")
```
...
``` {r,echo=FALSE}
plot(perAA,ballots-votes,main="Voting Discrepancies Versus African-American Percentage",xlab="Percentage of African-Americans in County",ylab="Number of Ballots Not Counted")
```
